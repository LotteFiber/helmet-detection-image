...
def write_jsonFile(fileOutput, date_time):
    with open('./dataCard/data'+date_time+'.json', 'w', encoding='utf-8') as f:
        json.dump(fileOutput, f, ensure_ascii=False, indent=4)
    return fileOutput

# write file data.json bu uuid


def write_jsonFileUuid(fileOutput, uuid):
    with open('./dataCard/'+uuid+'.json', 'w', encoding='utf-8') as f:
        json.dump(fileOutput, f, ensure_ascii=False, indent=4)
    return fileOutput
...
def read_card_detect(uuid):
    ...
    path_final_img = './data/ImageCardDate'+date_time
    path_final_img_db = 'data/ImageCardDate'+date_time
    ...
    for img_path in images_path:
        ...
        try:
            ...
            # crop_name = img_d[110:145, 150:455]
            # crop_student_id = img_d[135:170, 245:455]
            # crop_faculty = img_d[160:205, 150:455]
            ...
            print(student_id, name, first_name, last_name, faculty)

            # insert description student_id, first_name, last_name, faculty
            card_dict = {
                "image": str(path_final_img_db)+'/'+str("card_"+str(z)+".jpg"),
